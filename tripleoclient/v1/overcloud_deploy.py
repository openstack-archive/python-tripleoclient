...
class DeployOvercloud(command.Command):
    ...
    def build_image_params(self, env_files, parsed_args,
        ...
        roles_data = roles.get_roles_data(self.working_dir, parsed_args.stack)
    ...
    def _validate_args(self, parsed_args):
        ...
        if parsed_args.environment_files:
            ...
            if parsed_args.vip_file:
                if not os.path.isfile(parsed_args.vip_file):
                    nonexisting_envs.append(parsed_args.vip_file)
