...
class TestDeployOvercloud(fakes.TestDeployOvercloud):
    ...
    def test_tht_deploy(self, mock_tmpdir,
        ...
        calls = [
            ...
            mock.call('overcloud',
                      ...
                      yaml.safe_dump({
                          'environments': [{'path': 'user-environment.yaml'}]},
                          default_flow_style=False))]
    ...
    def test_try_overcloud_deploy_with_first_template_existing(
            self, mock_heat_deploy_func, mock_get_stack_output_item):
    ...
    def test_config_download_timeout(
            ...
            mock_copy, mock_get_stack_output_item, mock_get_ctlplane_attrs):
        fixture = deployment.DeploymentWorkflowFixture()
        self.useFixture(fixture)
        utils_fixture = deployment.UtilsOvercloudFixture()
        self.useFixture(utils_fixture)
